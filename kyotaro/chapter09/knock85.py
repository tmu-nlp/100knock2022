...
if __name__ == "__main__":
    ...
    # モデルの定義
    model = RNN(HIDDEN_SIZE, VOCAB_SIZE, EMB_SIZE, PADDING_IDX, OUTPUT_SIZE, NUM_LAYERS, emb_weights=weights, bidirectional=True)  # 双方向にする
    ...
    plot_result(log_train, log_valid, "85.png")
