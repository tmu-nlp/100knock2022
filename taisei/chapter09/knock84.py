...
class RNN(nn.Module): #初期値を引数に追加する
    def __init__(self, vocab_size, padding_idx, output_size, emb_size=300, hidden_size=50, emb_weights=None): #ネットワークが構成するレイヤー
        torch.manual_seed(0)
        super().__init__()
...
def train_model(dataset_train, dataset_valid, model, criterion, optimizer, batch_size=1, epochs=10, collate_fn=None, device=None):
    ...
    for i in tqdm(range(epochs)):
        ...
        torch.save({'epoch': i, 'model_state_dict': model.state_dict(), 'optimizer_state_dict': optimizer.state_dict()}, f'./output/knock84/checkpoint{i + 1}.pt')
        e_time = time.time()
...
if __name__ == "__main__":
    ...
    model = RNN(VOCAB_SIZE, PADDING_IDX, OUTPUT_SIZE, EMB_SIZE, HIDDEN_SIZE, emb_weights=weights)
    ...
    plot_log(log, "./output/knock84_loss_acc.png")
...
"""
epoch: 1, loss_train: 1.2932, accuracy_train: 0.4008, loss_valid: 1.2954, accuracy_valid: 0.3936, 3.6741sec
 10%|████████▏                                                                         | 1/10 [00:03<00:33,  3.68s/it]
epoch: 2, loss_train: 1.2394, accuracy_train: 0.4165, loss_valid: 1.2450, accuracy_valid: 0.4010, 3.5533sec
 20%|████████████████▍                                                                 | 2/10 [00:07<00:28,  3.61s/it]
epoch: 3, loss_train: 1.2073, accuracy_train: 0.4221, loss_valid: 1.2148, accuracy_valid: 0.4070, 3.6124sec
 30%|████████████████████████▌                                                         | 3/10 [00:10<00:25,  3.61s/it]
epoch: 4, loss_train: 1.1915, accuracy_train: 0.4234, loss_valid: 1.1999, accuracy_valid: 0.4070, 3.6348sec
 40%|████████████████████████████████▊                                                 | 4/10 [00:14<00:21,  3.62s/it]
epoch: 5, loss_train: 1.1842, accuracy_train: 0.4238, loss_valid: 1.1930, accuracy_valid: 0.4085, 3.6411sec
 50%|█████████████████████████████████████████                                         | 5/10 [00:18<00:18,  3.63s/it]
epoch: 6, loss_train: 1.1806, accuracy_train: 0.4260, loss_valid: 1.1896, accuracy_valid: 0.4085, 3.5840sec
 60%|█████████████████████████████████████████████████▏                                | 6/10 [00:21<00:14,  3.61s/it]
epoch: 7, loss_train: 1.1789, accuracy_train: 0.4261, loss_valid: 1.1880, accuracy_valid: 0.4085, 3.6693sec
 70%|█████████████████████████████████████████████████████████▍                        | 7/10 [00:25<00:10,  3.63s/it]
epoch: 8, loss_train: 1.1781, accuracy_train: 0.4261, loss_valid: 1.1872, accuracy_valid: 0.4063, 3.6048sec
 80%|█████████████████████████████████████████████████████████████████▌                | 8/10 [00:28<00:07,  3.62s/it]
epoch: 9, loss_train: 1.1777, accuracy_train: 0.4263, loss_valid: 1.1869, accuracy_valid: 0.4063, 3.7745sec
 90%|█████████████████████████████████████████████████████████████████████████▊        | 9/10 [00:32<00:03,  3.67s/it]
epoch: 10, loss_train: 1.1776, accuracy_train: 0.4266, loss_valid: 1.1868, accuracy_valid: 0.4070, 3.6357sec
